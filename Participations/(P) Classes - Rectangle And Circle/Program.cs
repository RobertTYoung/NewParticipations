...
namespace _P__Classes___Rectangle_And_Circle
{
    ...
    {//Robert Young
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"\nSince the first rectangles Length is {R1.Length} and the Width is {R1.Width} the Area is {R1.CalculateAreaR()}.");
            ...
            Console.WriteLine($"\nSince the first rectangles Length is {R2.Length} and the Width is {R2.Width} the Area is {R2.CalculateAreaR()}.");
            ...
            Console.WriteLine($"\nThe radius of the the circleis {C1.Radius} so the Area is {C1.CalculateAreaC()}.");
            Console.WriteLine($"The radius of the the circleis {C1.Radius} so the Perimeter is {C1.CalculatePerimeterC()}.");

            Circle C2 = new Circle(R);

            Console.WriteLine($"\nThe radius of the the circleis {C2.Radius} so the Area is {C2.CalculateAreaC()}.");
